...
def get_run_git_metadata(run_id: str, namespace: str | None = None) -> tuple[str | None, bool]:
...
def list_kfp_runs(page_size: int = 50, namespace: str | None = None) -> list[dict[str, Any]]:
